...
public class HighLow {
	...
	private static int play() {
		...
		while (true) { // Loop ends when user's prediction is wrong.
			 ...
			 * becomes the currentCard, since the currentCard has to be the card
			 * that the user sees, and the nextCard will be set to the next card
			 * in the deck after the user makes his prediction.
			 */
